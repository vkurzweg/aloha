    ...
    <div className="container" style={{ paddingTop: '7%' }}>
      ...
      <div className="row" style={{ marginLeft: '10%' }}>
        <div className="col-sm-5">
          <Image cloudName="kurzweg" publicId="jeff" width="400" quality="auto" responsive style={{ width: '100%', marginTop: '5%' }} />
        </div>
      ...
      <div className="row" style={{ marginLeft: '10%' }}>
        <div className="col-sm-5">
          <Image cloudName="kurzweg" publicId="kekai" width="400" quality="auto" responsive style={{ width: '100%', marginTop: '5%' }} />
        </div>
        <div className="col-sm-7">
      ...
      <div className="row" style={{ marginLeft: '10%', marginBottom: '5%' }}>
        <div className="col-sm-5">
          <Image cloudName="kurzweg" publicId="kawai" width="400" quality="auto" responsive style={{ width: '100%', marginTop: '5%' }} />
        </div>
        <div className="col-sm-7">
