  ...
  render() {
    const icons = (
      <div style={{ display: 'inline-flex', marginLeft: '-5%', width: '50%' }}>
        ...
        <a style={{ paddingLeft: '10px', display: 'inline-block' }} href="http://aloha-brothers-surf-lessons.business.site/" target="blank"><Image cloudName="kurzweg" publicId="google" responsive alt="google icon" style={{ paddingLeft: '15px' }} /></a>
    ...
    return (
      <div>
        <div style={{ position: 'fixed', width: '100%', zIndex: '100', top: '0' }}>
          <StyledAppBar
            title={brand}
            titleStyle={{ textDecoration: 'none', paddingTop: '.5%' }}
            ...
            iconStyleRight={{ marginTop: '1.5%', marginRight: '1.5%' }}
          />
          <StyledDrawer
            docked={false}
            width={200}
