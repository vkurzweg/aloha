...
import Palm1 from 'assets/icons/palmtree1.png';
import Palm2 from 'assets/icons/palmtree2.png';
  ...
  return (
    <div style={{ width: '100%', backgroundColor: 'black', top: '0' }}>
      <div style={{ zIndex: '10', dispay: 'block', margin: '0 auto', width: '100%', position: 'absolute', marginTop: '12%' }}>
        <h1 style={{ fontSize: '40px', fontFamily: 'Josefin Sans', textAlign: 'center', color: '#FAFAFA', textTransform: 'uppercase', letterSpacing: '5px' }}><img src={Palm1} role="presentation" /> Surf in Venice Beach <img src={Palm2} role="presentation" /></h1>
