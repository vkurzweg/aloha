    ...
    <div style={{ backgroundColor: '#ECECEC' }}>
      ...
      <div style={{ width: '100%', margin: '0 auto' }}>
        ...
        <div style={{ display: 'block', width: '100%', margin: '0 auto', textAlign: 'center' }}>
          <Image cloudName="kurzweg" publicId="latimes-logo-min" withd="100" quality="auto" responsive style={{ padding: '3%' }} alt="la times" />
          <Image cloudName="kurzweg" publicId="CBS-los-angeles-logo2-min" withd="100" quality="auto" responsive style={{ padding: '3%' }} alt="cbs los angeles" />
          <Image cloudName="kurzweg" publicId="lamag-min" quality="auto" responsive width="100" style={{ padding: '3%' }} alt="la magazine" />
          <Image cloudName="kurzweg" publicId="Huffington-Post-Logo-min" quality="auto" responsive width="100" style={{ padding: '3%' }} alt="huffington post" />
          <Image cloudName="kurzweg" publicId="telemundo-min" quality="auto" responsive width="100" style={{ padding: '3%' }} alt="telemundo" />
        </div>
