  ...
  return (
    <div style={{ backgroundColor: '#ECECEC' }}>
      ...
      <div style={{ display: 'inline-flex' }}>
        <img src={Nick} alt="surfing in venice, ca" style={{ height: '250px', marginLeft: '5%', marginTop: '3%' }} />
        <p style={{ padding: '5%', fontSize: '14px' }}>Born in Hawaii, Nick was pushed into his first wave by former world surfing champion Fred Hemmings when he was around 5 or 6, and has been in love with the ocean ever since. Fluent in Spanish, French, and Portuguese, Nick frequently gives surf lessons in these languages. Nick surfs daily and has taught countless friends and friends of friends and their friends too over the years. He almost always manages to get them up and riding the very first time they go out.</p>
      </div>
