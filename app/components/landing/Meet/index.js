      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-6">
            <Image className="item" cloudName="kurzweg" publicId="nick_q82h51" width="450" quality="auto" responsive style={{ paddingTop: '5%'}} />
          </div>
          <div className="col-sm-6" style={{ paddingRight: '3%' }}>
            ...
            <p style={{ fontSize: '16px', paddingTop: '2%', margin: '0 auto', width: '80%' }}>Fluent in <span style={{ color: '#7C4DFF' }}>Spanish</span>, <span style={{ color: '#FF80AB' }}>French</span>, <span style={{ color: '#108EE9' }}>Portuguese</span>, and conversational in <span style={{ color: '#FF9800' }}>Indonesian</span>, Nick frequently gives surf lessons in these languages.</p>
          </div>
        </div>
      </div>
