...
function RatesTables() {
  ...
  return (
    <div style={{ paddingTop: '18%', width: '100%' }}>
     ...
     <Image cloudName="kurzweg" publicId="backside_pop_crop" width="300" responsive style={{ padding: '2%', width: '75%', display: 'block', margin: '0 auto', background: `#ECECEC url(${spinner}) center no-repeat` }} />
     ...
     <div className="container" style={{ width: '100%', marginTop: '5%' }}>
       ...
       <div className="col-sm-6">
         ...
         <ul style={{ textAlign: 'left', fontSize: '14px', marginLeft: '10%', listStyleType: 'none' }}>
     ...
     <Link style={{ display: 'block' }} to="/gallery"><div style={{ border: 'none', borderRadius: '3px', backgroundColor: '#FF80AB', width: '75%', margin: '0 auto', marginBottom: '3%', marginTop: '-5%'}}>
       <Image cloudName="kurzweg" publicId="camera_white" alt="surf photography" style={{ display: 'block', margin: '0 auto'}} />
       <p style={{ color: '#ECECEC', textAlign: 'center', fontSize: '16px', padding: '4%' }}>Add photography to your lesson from $85</p>
     </div></Link>

     <Image cloudName="kurzweg" publicId="venice_background_oblfde" width="300" responsive alt="walking with surfboards in Venice" style={{ display: 'block', margin: '0 auto', marginBottom: '4%', width: '75%' }} />
     ...
     <Image cloudName="kurzweg" publicId="bali" width="300" responsive style={{ padding: '2%', width: '75%', display: 'block', margin: '0 auto', background: `#ECECEC url(${spinner}) center no-repeat` }} />
     ...
     <Image cloudName="kurzweg" publicId="shoulder_shimmy" width="300" responsive style={{ padding: '2%', width: '75%', display: 'block', margin: '0 auto', background: `#ECECEC url(${spinner}) center no-repeat` }} />
   </div>
  );
}
