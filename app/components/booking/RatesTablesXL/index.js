  ...
  return (
    <div className="col-sm-6">
     ...
     <div style={{ fontSize: '16px', fontFamily: 'Josefin Sans', width: '75%', margin: '0 auto', textAlign: 'center', marginTop: '2%' }}>
       <p style={{ fontFamily: 'Josefin Sans', fontSize: '20px' }}>All lessons last 90 minutes (water time)</p>
     ...
     <ul style={{ textAlign: 'left', fontSize: '20px', marginLeft: '7%', marginTop: '2%', width: '80%'}}>
