          ...
          <div className="container" style={{ width: '100%' }}>
            <div className="row" style={{ width: '100%', marginTop: '8%' }}>
              ...
              <div className="col-sm-3">
                ...
                <Link style={{ display: 'block', textDecoration: 'none' }} to="/gallery"><div style={{ border: 'none', borderRadius: '3px', backgroundColor: '#FF80AB', width: '100%', margin: '0 auto', padding: '10%'}}>
